...
import jack.ultrajack.jac.healthwatcher.math.Fft;
...
public class BloodPressureProcess extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null) {
            ...
            Agg= extras.getInt("age");
            Wei=extras.getInt("weight");
            Hei=  extras.getInt("height");
            Gen=  extras.getInt("gender");
    ...
    private  SurfaceHolder.Callback surfaceCallback = new SurfaceHolder.Callback() {
        ...
        public void surfaceCreated(SurfaceHolder holder) {
            try {
                ...
                Log.e("PreviewDemo-surfCallB", "Exception in setPreviewDisplay()", t);
            }
        }
